...
return array(
	...
	array(
		...
		'default_faqs' => array(
			...
			array( 'q' => 'Do you repair older pool systems when parts are discontinued?', 'a' => 'Yes. We diagnose older pumps, filters, heaters, valves, and control systems before recommending replacement. If a safe compatible part is available and the repair still makes financial sense, we repair it. If parts are discontinued or the unit is beyond its practical service life, we provide a written repair-versus-replacement comparison before any work is approved.' ),
	...
	array(
		...
		'seo_title'         => 'Pool Leak Detection in Los Angeles | Showtime Pools',
	...
	array(
		...
		'default_faqs' => array(
			...
			array( 'q' => 'Do you provide weekly pool service for HOAs, apartment communities, and other shared-use pools?', 'a' => 'Yes, subject to a site assessment and route capacity. Shared-use and commercial service can be scheduled weekly or more often based on bather load, equipment count, access, and reporting needs. We confirm service windows, communication, and any tenant or guest access requirements with the property manager in the written service plan.' ),
		),
	),
	...
	array(
		...
		'default_faqs' => array(
			...
			array( 'q' => 'Can you convert my pool to a saltwater system during a remodel?', 'a' => 'Yes, when the existing pool and equipment are compatible. A conversion can include a salt cell and controller, salt addition, plumbing or electrical adjustments, and automation programming. During a remodel, startup chemistry must also be managed carefully to protect the new finish, so compatibility and warranty requirements are confirmed in the written quote.' ),
			array( 'q' => 'How are payments structured for a pool remodeling project?', 'a' => 'Pool remodeling payments follow a milestone schedule stated in the signed contract. The exact milestones depend on the approved scope and may align with the deposit, defined construction phases, and final completion. Any added work or revised cost is documented in writing and requires approval before the extra work begins.' ),
			array( 'q' => 'What happens if hidden damage is discovered after the pool is drained or demolition begins?', 'a' => 'If hidden plumbing damage, delamination, structural concerns, or other concealed conditions appear after draining or demolition, we document the issue with photos and pause the affected work. We then explain the options, schedule impact, and written change order. No additional work proceeds until the owner approves it.' ),
			array( 'q' => 'Do you remodel pools for HOAs, apartment communities, or other commercial properties?', 'a' => 'Yes, after a site assessment. Commercial remodel scopes may include resurfacing, tile and coping, decking, equipment, or coordinated repairs. Access, resident or guest use, permits, inspections, and service interruptions are addressed in the written project plan so the property manager understands the sequence before work begins.' ),
		),
	),
	...
	array(
		...
		'default_faqs' => array(
			...
			array( 'q' => 'Are variable-speed pool pump motors required in California?', 'a' => 'California Title 20 requires replacement dedicated-purpose pool pump motors rated from 0.5 through 5 total horsepower and manufactured on or after July 19, 2021, to be variable-speed. Some specialty applications fall outside that definition, so we verify the motor type, horsepower, and compliant equipment selection during the assessment.' ),
	...
	array(
		...
		'seo_title'         => 'Smart Pool Automation in Los Angeles | Showtime Pools',
	...
	array(
		...
		'default_faqs' => array(
			...
			array( 'q' => 'Will inspections be required during my new pool project?', 'a' => 'Yes. Permitted construction in Los Angeles is inspected in stages, and work generally must be approved before it is covered or concealed. The exact building, plumbing, electrical, grading, or final inspections depend on the jurisdiction and project scope. We coordinate the applicable inspections and include them in the project schedule.' ),
	...
	array(
		...
		'default_faqs' => array(
			...
			array( 'q' => 'What should I do before hardscape construction begins?', 'a' => 'Before construction, remove portable furniture and personal items from the work area and tell us about gate access, parking limits, pets, HOA rules, irrigation, and known private utilities. During the pre-construction walk-through, we confirm staging, surface protection, utility-location needs, and the access plan. Do not remove fixed items unless the project team requests it.' ),
		),
	),
