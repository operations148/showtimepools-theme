 ...
 *
 * /pool-inspections/ — Showtime Pools independent inspection line. Charcoal + amber.
...
if ( '' === $why_eyebrow )   { $why_eyebrow   = 'Why independent'; }
if ( '' === $why_h2 )        { $why_h2        = 'A separate line for inspections, by design.'; }
if ( '' === $why_para1 )     { $why_para1     = 'Most pool inspections are done by the same companies that want to win the resulting repair contract. That conflict shapes the report. We run inspections as a separate, independent line so the report comes from a different P&L than the construction quote.'; }
		...
		<div class="container">
			...
			<div class="int-hero__inner">
				<span class="mechanics__brand">
					...
					<?php esc_html_e( 'Showtime Pools', 'showtime-pools' ); ?>
				</span>
				<h1 class="int-hero__title balance"><?php echo esc_html( $hero_h1 ); ?></h1>
				<p class="int-hero__lead"><?php echo esc_html( $hero_lead ); ?></p>
				<div class="cluster">
					<a class="btn btn--inspections btn--lg" href="<?php echo esc_url( showtime_booking_url() ); ?>"><?php esc_html_e( 'Schedule an inspection', 'showtime-pools' ); ?></a>
