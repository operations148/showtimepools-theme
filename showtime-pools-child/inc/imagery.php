...
function showtime_image( string $slot, int $w = 1600, int $h = 0 ): string {
	...
	// hard-refresh, done.
	$local_slots = array( 'founder', 'about_hero', 'about_split', 'hero', 'hero_poster', 'lifestyle_main', 'lifestyle_1', 'lifestyle_2', 'lifestyle_3', 'lifestyle_4', 'inspections_bg', 'interactive_pool', 'add_spa', 'add_rock', 'add_bar', 'add_diving', 'add_fire', 'add_water', 'add_deckjets', 'showtime-intro-poster' );
