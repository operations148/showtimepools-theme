...
require_once SHOWTIME_CHILD_DIR . '/inc/metasync-compat.php';
...
require_once SHOWTIME_CHILD_DIR . '/inc/project-compare.php';
require_once SHOWTIME_CHILD_DIR . '/inc/service-areas.php';
