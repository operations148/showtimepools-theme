		...
		<div class="container site-header__inner">
			...
			<div class="site-header__actions">
				<?php if ( ! is_front_page() ) : ?>
					<?php
					// Homepage carries the phone number inside the hero instead
					// (Call/Text line under the primary CTA) — kept in the header
					// on every other page since there is no hero replacement there.
