...
$faqs_default = array(
		...
		array(
			...
			'a' => __( 'The crew is in-house for everything except Replaster and demo, which are handled by partner crews we work with exclusively. Steve is on-site supervising 100% of the time, whether the work is in-house or partner. The same tech services your pool every week.', 'showtime-pools' ),
		),
		array(
		...
		array(
			...
			'a' => __( 'The same in-house tech every visit. Photo report after each visit. The person who quotes the job is on-site when the work happens. Steve supervises every job, including the exclusive partner crews we use for Replaster and demo.', 'showtime-pools' ),
		),
		array(
