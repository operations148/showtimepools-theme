	...
	<div class="container">
		...
		<div class="lifestyle__grid">
			<figure class="lifestyle__cell lifestyle__cell--main">
				<img src="<?php echo esc_url( showtime_image( 'lifestyle_main', 1200 ) ); ?>" alt="" loading="lazy" decoding="async">
				<figcaption>
			...
			<figure class="lifestyle__cell">
				<img src="<?php echo esc_url( showtime_image( 'lifestyle_1', 800 ) ); ?>" alt="" loading="lazy" decoding="async">
				<figcaption>
			...
			<figure class="lifestyle__cell">
				<img src="<?php echo esc_url( showtime_image( 'lifestyle_2', 800 ) ); ?>" alt="" loading="lazy" decoding="async">
				<figcaption>
			...
			<figure class="lifestyle__cell">
				<img src="<?php echo esc_url( showtime_image( 'lifestyle_3', 800 ) ); ?>" alt="" loading="lazy" decoding="async">
				<figcaption>
			...
			<figure class="lifestyle__cell">
				<img src="<?php echo esc_url( showtime_image( 'lifestyle_4', 800 ) ); ?>" alt="" loading="lazy" decoding="async">
				<figcaption>
